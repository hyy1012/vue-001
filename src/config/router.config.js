...

  {
    ...
    children: [
      ...
      // forms
      {
        ...
        children: [
          {
            path: '/form/mybase-form',
            name: 'BaseForm',
            component: () => import('@/views/form/MyBasicForm'),
      ...
      // 新增页面
      {
        ...
        component: RouteView,
        meta: { title: '新增页面', keepAlive: true, permission: [ 'dashboard' ] },
        children: [
          {
            path: '/new-router/ahaha',
            name: 'ahaha',
            component: () => import('@/views/newPage/newPage'),
            meta: { title: '新增页面', keepAlive: false, permission: [ 'dashboard' ] }
          }
        ]
      }
    ]
